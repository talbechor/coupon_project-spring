...
public interface CouponRepository extends JpaRepository<Coupon, Integer> {
    ...
    void decreaseCouponAmount(int coupon_id);
    ...
    void deleteCouponPurchaseByCustomerID(int customer_id);
    ...
    void deleteCouponPurchaseByCouponID(int coupon_id);
    ...
    void deleteCompanyCoupons(int company_id);
    ...
    List<Coupon> getAllCouponsCustomer(int customer_id);
    ...
    List<Coupon> getAllCouponCustomerByCategory(int customer_id, int category);
    ...
    List<Coupon> getAllCouponsCustomerByPrice(int customer_id, double MaxPrice);
